...
import java.util.*;
public class Agent10Bean  extends AbstractAgentBean{
    private String usname="10";
    ...
    public Agent2Bean getAgent2() {
        return Agent2;
    }
    public void setAgent2(Agent2Bean agent2) {
        Agent2 = agent2;
    }
...
//
    ...
    public Agent10Bean(String host, String username, String pass, int port) {
