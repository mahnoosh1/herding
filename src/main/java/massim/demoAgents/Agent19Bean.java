...
import java.util.*;
public class Agent19Bean  extends AbstractAgentBean{
    private String usname="17";
...
//
    ...
    private class HandleHerdGroup implements SpaceObserver<IFact>{
        ...
        public void notify(SpaceEvent<? extends IFact> event) {
            if (event instanceof WriteCallEvent) {
                //if (iu != 1) {
                log.println("Agent"+username + "yekshodam" +" "+action+" in step "+step);
                log.flush();
                fw.flush();;
    ...
    public Agent19Bean(String host, String username, String pass, int port) {
